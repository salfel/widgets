...
main :: proc() {
	...
	box_style_set_width(child2, 500, &app_context.renderer)
	box_style_set_height(child2, 100, &app_context.renderer)
	box_style_set_background(child2, RED, &app_context.renderer)
	box_style_set_margin(child2, sides_make(20, 0), &app_context.renderer)
	...
	box_style_set_height(child3, 100, &app_context.renderer)
